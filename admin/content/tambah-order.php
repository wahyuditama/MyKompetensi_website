...
$querytrans_Detail = mysqli_query($koneksi, "SELECT customer.customer_name,customer.phone,customer.alamat, 
trans_order.order_code,trans_order.order_date,trans_order.status, 
service.service_name,service.harga, detail_trans_order.*FROM detail_trans_order 
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="date"
                                                            ...
                                                            required
                                                            value="<?php echo isset($_GET['edit']) ? $rowEdit['order_end_date'] : '' ?>">
                                                    </div>
                                                    <div class="col-sm-6">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <select data-mdb-select-init name="id_service[]" class="form-control" id="serviceSelect">
                                                            <option value="">Pilih service</option>
                                                            <?php foreach ($rowService as $key => $value) { ?>
                                                                <option value="<?php echo $value['id']; ?>" data-price="<?php echo $value['harga']; ?>">
